 ...
 * 
 * ⚠️ DEPRECATED: use-hotdeals.ts는 LocalStorage 기반 시스템을 사용합니다.
 * 
 * 🔄 대신 사용할 훅:
 * - useSupabaseHotdeals() - 완전한 Supabase 기반 핫딜 시스템
 * 
 * 📋 마이그레이션 가이드:
 * 기존: const { hotdeals, isLoading } = useHotDeals()
 * 신규: const { hotdeals, isLoading } = useSupabaseHotdeals()
 * 
