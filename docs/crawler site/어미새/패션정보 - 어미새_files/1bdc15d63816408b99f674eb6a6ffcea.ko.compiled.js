...
(function($){
	...
	v.cast("ADD_FILTER", ["insert_comment", {'star_point': {},'document_srl': {required:true},'nick_name': {required:true,maxlength:20},'password': {required:true},'email_address': {maxlength:250,rule:'email'},'homepage': {maxlength:250,rule:'url'},'content': {required:true,minlength:1}}]);
	
	v.cast('ADD_MESSAGE',['star_point','star_point']);
