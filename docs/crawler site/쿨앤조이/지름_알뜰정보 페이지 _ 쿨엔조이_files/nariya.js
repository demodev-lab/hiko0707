...
function na_comment2(id) {
	var str;	
	var c_url;
	var c_good = 1;
	if(id == 'viewcomment') {
		c_url = g5_url + '/nariya/bbs/comment_write.php?c_good=' + c_good;
...
function bbs_mycomment(id) {

	var	href = g5_url + '/nariya/bbs/bbs_mycomment.php';
...
function get_events(id) {
	...
	var	href = g5_url + '/nariya/bbs/get_events.php';
...
function review_secret(bo_table,wr_id) {
	var	href = g5_url + '/nariya/bbs/review_secret.php?bo_table=' + bo_table + '&wr_id=' + wr_id;
