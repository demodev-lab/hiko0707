...
export function TranslatedContent({ 
  ...
  // 한국어는 원본 표시
  if (language === 'ko') {
    const content = field === 'productComment' ? hotDeal.productComment : field === 'title' ? hotDeal.title : ''
  ...
  const originalContent = field === 'productComment' ? hotDeal.productComment : field === 'title' ? hotDeal.title : ''
